...
MEDIALIB_THUMB_SIZE = {
    ...
    'specials_list': (3840, 1040, 'crop'),  # в слайдере спецпроектов на Главной странице и в ленте всех спецпроектов

    # Киноанонсы
    'film_detail': (616, 870),  # на собственных страницах киноанонсов
    'films_list': (396, 560),  # внутри ленты с афишей кинотеатра
    'film_banner': (460, 670),  # в блоке про кинотеатр на Главной странице
