<template>
    <div>
        ...
        <router-link :to="{name: 'restore-password'}" tag="button" class="button auth-secondary-button auth-secondary-button-size">
            Забыли пароль?
        </router-link>
    </div>
</template>
...
<script>
    ...
    import src from '../../../cp_vue/frontend/vue/components/authentication/Signin.vue'
    export default src
</script>